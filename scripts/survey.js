...
function validate(e)
{
    ...
    //validate pizza size
    let validHours = validateSelectList('hours', 'error-hours');
    //validate pizza delievery method
    let validRecommend = validateRadioButtons('recommend', 'error-recommend');
    //validate the checkbox
    let validTerms = validateCheckBox('terms', 'error-terms');
    
    let validInput = validFirst && validLast && validHours && validRecommend && validTerms;
